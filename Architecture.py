...
class MyNet(nn.Module):
    def __init__(self, layers=[1, 1, 1, 1], vector_coordinates=12576, rollSets=[1, 1, 1]):
        ...
        self.layer1 = self._make_layer(layers[0], rollSets[0])  # 256->128
        self.layer2 = self._make_layer(layers[1], rollSets[1])  # 128->64
        self.layer3 = self._make_layer(layers[2], rollSets[2])  # 64->32
    ...
    def forward(self, x):
        x = self.relu(self.bn(self.conv1(x)))  # 256
